...
<%= (deposited == null ? " hidden" : "") %> z-50">

   
    <h1 class=" mt-6 text-[13.5px] font-semibold tracking-wide ml-2">
        Your amount has been deposited: <br> <div class="text-xl text-green-600"> Rs <%= deposited %></div> 
    </h1>
...
<%= (deposited != null ? " hidden" : "") %>">
   
    <h1 class="text-[13.5px] font-semibold tracking-wide ml-2">Deposit:</h1>
    ...
    <form action="${pageContext.request.contextPath}/Deposit" method="POST">
        ...
        <div class="grid grid-cols-2 gap-1 gap-x-8 text-black w-full">
            ...
            <button class="bg-[#D7DAE0] px-4 py-2 rounded font-semibold text-xs shadow hover:text-white hover:bg-gray-400 active:bg-gray-400 active:scale-95 transition cursor-pointer"
                name="action" value="deposit">Deposit</button>
